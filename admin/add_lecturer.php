...
if(isset($save))
{
$que=mysqli_query($con,"select * from lecturer where eid='$e'");		
$row=mysqli_num_rows($que);
	if($row)
	{
	$err="<font color='red'>This lecturer already exists</font>";
	}
	else
	{
mysqli_query($con,"insert into lecturer values('','$n','$e','$p','$m','$a','$courseid','$s','$status',now())");	
...
<table border="0" class="table">
  ...
  <td colspan="2"><?php echo @$err; ?></td>
   ...
   <tr>
    ...
    <td width="213">
	<select name="courseid" id="courseid" onchange="showSemester(this.value)" class="form-control" required>
  ...
  <tr>
    ...
    <td width="213">
	<select name="s" id="semester" onchange="showsemester(this.value)" class="form-control" required>
  ...
  <tr>
    ...
    <td width="213"><input type="text" name="n" class="form-control" placeholder="enter your name" required/></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><input type="password" name="p" class="form-control" placeholder="enter your email" required/></td>
  </tr>
  ...
  <tr>
	...
	<td>
	<input type="submit" value="Add lecturer" name="save" class="btn btn-success" />
