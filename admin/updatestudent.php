...
unlink("../student/image/$email/$oldimg");
	...
	mysqli_query($con,"update student set name='$name',eid='$eid',password='$p',mob='$mobile',address='$address',department_id='$course',class_id='$class', sem_id='$semester',
...
<!---- class-->
   <tr>
    <th width="237" scope="row">Class/Year of Study </th>
    <td width="213">
	
	<select name="class" id="class" class="form-control">
	<?php	
	$clas=mysqli_query($con,"select * from class where class_id='".$res['class_id']."'");
	while($c=mysqli_fetch_array($clas))
	{
	$c_id=$c[0];
	?>
