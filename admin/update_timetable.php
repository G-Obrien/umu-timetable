...
if(isset($update))
{
   	mysqli_query($con,"update timeschedule set department_name='$course',semester_name='$s',subject_name='$subname',time='$time',date='$date',lecturer_id='$lecturer' where timeschedule_id='$timeschedule_id' ");
...
<form method="POST" enctype="multipart/form-data">
  ...
  <tr>
    ...
    <td width="213">
	<select name="lecturer" id="lecturerid" onchange="showlecturer(this.value)" class="form-control">
	<?php
	$t=mysqli_query($con,"select * from lecturer");
  ...
  <tr>
    <th width="237" scope="row">Enter  Start-Time </th>
