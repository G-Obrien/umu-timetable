...
$q=mysqli_query($con,"select * from lecturer where lecturer_id='$lecturer_id'");
$res=mysqli_fetch_assoc($q);
extract($_POST);
if(isset($update))
{	

	mysqli_query($con,"update lecturer set name='$n',eid='$e',password='$p',mob='$m',address='$a',department_id='$dep_id',sem_id='$semester' where lecturer_id='$lecturer_id' ");
