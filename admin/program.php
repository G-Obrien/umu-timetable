...
echo "<tr class='danger'><th colspan='54'> <center><h4>Programs/Courses Available at Uganda Martyrs University</h4></center></th></tr>";
echo "<tr class='danger'><th colspan='6'><a href='admindashboard.php?info=add_program'>Add New Program</a></th></tr>";

echo "<Tr><th>Program Id</th><th>Program Name</th><th>Department / Faculty</th>
