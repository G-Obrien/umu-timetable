...
if(isset($save))
{
$que=mysqli_query($con,"select * from room where room_name='$roomname'");	
$row=mysqli_num_rows($que);
	if($row)
	{
	$err="<font color='red'>The room is already added!</font>";
	}
	else
	{
mysqli_query($con,"insert into room values('','$roomname','$s','$roomid')");	

	$err="<font color='blue'>Room Saved Successfully..!!</font>";
	}
...
<form method="POST" enctype="multipart/form-data">
  ...
  <tr>
    <th width="237" scope="row">Select Department/Faculty -(<i>room location..</i>)</th>
    <td width="213">
	<select name="roomid" id="roomid" onchange="showSemester(this.value)" class="form-control">
  ...
  */
  ?>
  <tr>
    <th width="237" scope="row">Room Name/Label </th>
