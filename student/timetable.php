...
include('../config.php');
 ...
 //<!--data display   SELECT * FROM `timeschedule` ORDER BY `timeschedule`.`department_name` ASC --> 
	...
	<form action="studentdashboard.php?info=timetable" method="post" class="form2">
...
if (isset($_POST['lang'])) {
	...
	echo "<tr class='danger'><th colspan='9'>
	<center>
	<a href='studentdashboard.php?info=timetable'>
 ...
 //	date_default_timezone_get('h:i:sa');
	...
	echo "<td><a href='studentdashboard.php?info=viewTimeinfo=$res[timeschedule_id]'>View Details</a></td>";
	?>
