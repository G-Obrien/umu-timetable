...
<div class="col-md-5"> 
               ...
               <h3><font color="black">Update Password</font></h3>
<form method="POST" enctype="multipart/form-data">
  ...
  <tr>
    <th width="237" scope="row"><font color="black" size="3">Old Password</font> </th>
    <td width="213"><input type="text" name="op" class="form-control" value="<?php echo $res['password'];?>"/></td>
  </tr>
  
  <tr>
    <th width="237" scope="row"><font color="black" size="3">New Password </font></th>
    <td width="213"><input type="password" name="np" class="form-control" value="<?php echo $np; ?>"/></td>
  </tr>
  
  <tr>
    <th width="237" scope="row"><font color="black" size="3">Confirm Password</font> </th>
