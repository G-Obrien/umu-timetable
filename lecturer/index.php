...
if(isset($save))
{
	...
	$que=mysqli_query($con,"select * from lecturer where eid='".$e."' and password='".$p."'");
	$r=mysqli_num_rows($que);
	$res=mysqli_fetch_array($que);	
	if($r)
		{
		$_SESSION['lname']=$res['name'];
		$_SESSION['lecturer_id']=$res['lecturer_id'];
		echo "<script>window.location='staffdashboard.php'</script>";
		}
		else
		{
			$err="<font ><b class='feed-d'><i class='fas fa-allergies'></i> - Please Wait;  Invalid Login, Try again..!</b></font>";
...
<link href="bootstrap/../css/bootstrap.min.css" rel="stylesheet" type="text/css">
 ...
 <link rel="shortcut icon" href="img/Logo.png" type="image/x-icon">
    <title>UMU TimetableManagementSystem:Login=Lecturer</title>
...
.col-md-5{
    ...
    border-radius:12px;
    padding:30px;
    background: rgba(95, 29, 14, 0.548);
}
.btn{
    background:pink;
    width:290px;
...
<div class="col-md-5" align="center">
        ...
        <img src="img/Logo.png" alt="" srcset="" width="90px"><hr>
	    <h1 class="form-signin-heading"><font color="pink" size="+2"><i class="fas fa-lock"></i> - Lecturer Login</font></h2>
         <h3><?php echo $err; ?></h3>
        ...
        <input type="submit" value="Login" class="btn" name="save" style="background-color:pink"/><br><br>
         <a href="../index.php"><input type="button" value="EXIT" class="btn"  style="background-color:brown; color:white;"></a>
